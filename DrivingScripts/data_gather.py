...
rain_preset_names = [['Clear Noon', 'Soft Rain Noon', 'Mid Rainy Noon', 'Hard Rain Noon'], ['Clear Night', 'Hard Rain Night', 'Mid Rainy Night', 'Soft Rain Night']]
...
class World(object):
    ...
    def get_preset_by_name(self, x):
        #print([v[1] for v in self._weather_presets])
    ...
    def get_random_preset_pair(self):
        ...
        b = self.get_preset_by_name(rain)
        return (a, b)
