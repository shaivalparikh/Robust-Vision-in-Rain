    ...
    def set_sensor(self, index, notify=True, force_respawn=False):
        ...
        if needs_respawn:
            ...
            self.sensor = self._parent.get_world().spawn_actor(
                ...
                attach_to=self._parent,
                attachment_type=self._camera_transforms[self.transform_index + 1][1])
    ...
    def render(self, display):
        ...
        if self.surface is not None:
            if self.segmented is None:
                ...
                # https://stackoverflow.com/questions/48876373/pygame-joining-2-surfaces-together
                #new_surface = pygame.Surface((self.surface.get_width() + self.segmented.get_width(), self.surface.get_height()))
                #new_surface.blit(self.surface, (0, 0))
                #new_surface.blit(self.segmented, (self.surface.get_width(), 0))
                #display.blit(new_surface, (0, 0))
                display.blit(self.surface, (0, 0))
                display.blit(self.segmented, (self.surface.get_width(), 0))
